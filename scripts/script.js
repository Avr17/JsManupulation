document.addEventListener('DOMContentLoaded', (event) => {
    ...
    // chamando a função para carregar o usuario
    loadUserDataList();
    //evento para chamar o alert
    //alert("A pagina foi totalmente carregada ejs foi implantado")
...
const loadUserDataList = () => {
    ...
    if (localStorage.getItem('users')){
       const listUsers = JSON.parse(localStorage.getItem('users'))  //json -> arquivo
